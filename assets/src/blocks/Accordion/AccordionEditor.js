...
//renders the editor view
  renderView() {
    const { attributes } = this.props;
    console.log(this.props + "renderView(props)");

    let headingId = ["headingOne", "headingTwo", "headingThree"];
    for (let i = 0; i < headingId; i++) {
      headingId.push(<CardHeader key={i} />);
      console.log(this.headingId + "headingId(props)");
    }
    return <Fragment>
